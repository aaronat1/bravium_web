...
export const es = {
  ...
  landingPage: {
    ...
    pricing: {
      ...
      plan_starter_target: "Para empezar a construir confianza digital.",
      feature_emissions_starter: "100 emisiones de credenciales/mes",
      feature_verifications_starter: "1.000 verificaciones/mes",
      feature_templates: "Plantillas de credenciales",
      feature_support_email: "Soporte por email",
      cta_choose_starter: "Elegir Starter",
      plan_pro_title: "Pro",
      plan_pro_target: "La solución ideal para crecer y escalar.",
      popular: "Más Popular",
      feature_emissions_pro: "500 emisiones de credenciales/mes",
      feature_verifications_pro: "5.000 verificaciones/mes",
      feature_ai_assistant: "Asistente IA para crear plantillas",
      feature_attachments: "Soporte para ficheros adjuntos (1 GB incl.)",
      feature_support_priority: "Soporte prioritario",
      cta_choose_pro: "Elegir Plan Pro",
      plan_enterprise_title: "Enterprise",
      plan_enterprise_target: "Para organizaciones con necesidades a gran escala.",
      price_custom: "Personalizado",
      feature_volume: "Volúmenes de emisión y almacenamiento personalizados",
      feature_api: "Integración API completa",
      feature_sla: "Acuerdos de Nivel de Servicio (SLA)",
      feature_support_dedicated: "Soporte dedicado",
      cta_contact_sales: "Contactar con Ventas",
    },
    faq: {
