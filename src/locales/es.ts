...
export const es = {
  ...
  helpPage: {
    title: "Cómo Funciona Bravium",
    subtitle: "Entiende el ciclo de vida completo de una credencial verificable, desde su emisión hasta su verificación.",
    protagonists_title: "Los Protagonistas",
    protagonist_institution_name: "La Institución Emisora",
    protagonist_institution_role: "Crea y emite las credenciales (ej: una universidad).",
    protagonist_recipient_name: "El Receptor",
    protagonist_recipient_role: "Recibe y posee la credencial (ej: un estudiante).",
    protagonist_verifier_name: "El Verificador",
    protagonist_verifier_role: "Necesita confirmar la validez de la credencial (ej: un departamento de RRHH).",
    step1_title: "Paso 1: Emisión",
    step1_subtitle: "La institución crea una credencial verificable.",
    step1_desc: "Desde el panel de Bravium, la institución emisora (como una universidad) utiliza una plantilla para crear una credencial para un destinatario (como un estudiante).",
    step1_point1: "Selecciona una plantilla (ej: 'Diploma Universitario').",
    step1_point2: "Rellena los datos del estudiante (nombre, carrera, fecha).",
    step1_point3: "Al hacer clic en 'Emitir', Bravium genera un certificado criptográficamente seguro (JWS).",
    step2_title: "Paso 2: Entrega",
    step2_subtitle: "El estudiante recibe su credencial digital.",
    step2_desc: "La credencial, en formato de texto (JWS) junto con un código QR y un PDF, se envía al estudiante. Ahora es suya para siempre.",
    step2_point1: "El estudiante puede almacenar el JWS, guardar el PDF o simplemente usar el QR.",
    step2_point2: "Tiene control total para compartirla con quien quiera.",
    step3_title: "Paso 3: Verificación",
    step3_subtitle: "Un empleador verifica la autenticidad del título.",
    step3_desc: "El estudiante presenta su credencial a un potencial empleador. El empleador puede verificar su validez en segundos, sin contactar a la universidad.",
    step3_point1: "Escanea el código QR del PDF o del móvil del estudiante.",
    step3_point2: "Pega el texto del JWS en la página de 'Verificar' de Bravium.",
    step3_point3: "El sistema comprueba la firma criptográfica contra la blockchain y muestra instantáneamente si la credencial es válida y no ha sido alterada.",
  },
  registerPage: {
  ...
  customersPage: {
    ...
    col_apiKey: "Clave API",
    col_createdAt: "Fecha Creación",
    col_renewalDate: "Fecha Renovación",
    col_plan: "Plan",
    col_status: "Estado",
  ...
  templatesPage: {
    ...
    form_public_label: "Plantilla Pública",
    form_public_desc: "Permitir que esta plantilla se use en la página de demostración pública.",
  ...
  issueCredentialPage: {
    ...
    tab_single: "Emisión Individual",
    tab_batch: "Emisión por Lotes (CSV)",
    ...
    close_button: "Cerrar",
    batch_title: "Emisión por Lotes vía CSV",
    batch_desc: "Sigue los pasos a continuación para emitir múltiples credenciales de una vez.",
    batch_file_error_title: "Plantilla No Soportada",
    batch_file_error_desc: "La emisión por lotes no es compatible con plantillas que contienen campos de tipo fichero adjunto.",
    batch_step1_title: "Paso 1: Descargar Plantilla",
    batch_step1_desc: "Descarga la plantilla CSV, ábrela en un editor de hojas de cálculo y rellena los datos de cada destinatario.",
    batch_download_button: "Descargar Plantilla CSV",
    batch_step2_title: "Paso 2: Subir Fichero",
    batch_step2_desc: "Sube el fichero CSV completado. Asegúrate de no haber modificado las cabeceras.",
    batch_issue_button: "Emitir Lote de Credenciales",
    batch_progress_title: "Emitiendo Credenciales...",
    batch_result_title: "Emisión por Lotes Completada",
    batch_result_desc: "{success} de {total} credenciales se emitieron correctamente.",
    batch_result_row: "Fila"
  },
  cookieConsent: {
  ...
  profilePage: {
    title: "Mi Perfil",
    subtitle: "Consulta y gestiona los detalles de tu cuenta.",
    profile_details_title: "Detalles del Perfil",
    profile_details_desc: "Actualiza tu nombre aquí. El email no se puede cambiar.",
    name_label: "Nombre",
    email_label: "Email",
    save_button: "Guardar Cambios",
    name_update_success: "Nombre actualizado correctamente.",
    name_update_fail: "Error al actualizar el nombre.",
    name_required: "El nombre es obligatorio.",
    account_info_title: "Información de la Cuenta",
    plan_label: "Plan Actual",
    status_label: "Estado de la Suscripción",
    created_at_label: "Fecha de Alta",
    renews_at_label: "Fecha de Renovación",
    api_key_label: "Clave API",
    security_title: "Seguridad",
    security_desc: "Gestiona la seguridad de tu cuenta.",
    change_password_button: "Cambiar Contraseña",
    password_reset_success: "Se ha enviado un correo para restablecer la contraseña.",
    password_reset_fail: "Error al enviar el correo de restablecimiento.",
    danger_zone_title: "Zona de Peligro",
    delete_account_button: "Eliminar Cuenta",
    delete_account_dialog_title: "¿Estás absolutely seguro?",
    delete_account_dialog_desc: "Esta acción no se puede deshacer. Se eliminará permanentemente tu cuenta y se borrarán tus datos de nuestros servidores.",
    delete_account_confirm_button: "Sí, eliminar mi cuenta",
