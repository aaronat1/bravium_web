...
export const es = {
  ...
  helpPage: {
    ...
    protagonist_institution_role: "Una universidad online",
    protagonist_recipient_name: "ELENA",
    protagonist_recipient_role: "Una estudiante que acaba de completar un curso",
    protagonist_verifier_name: "DAVID",
    protagonist_verifier_role: "Un reclutador de una empresa de tecnología",
