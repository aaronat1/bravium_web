...
export const en = {
  ...
  landingPage: {
    ...
    pricing: {
      ...
      plan_pro_title: "Pro",
      plan_pro_target: "For growing SMEs, faculties, and established organizations.",
      plan_pro_price: "€149/month",
      popular: "Most Popular",
      feature_emissions_pro: "Up to 300 Issuances/month",
      feature_storage_pro: "10 GB Secure Storage",
      feature_api_access: "API Access",
      plan_enterprise_title: "Enterprise",
      plan_enterprise_target: "For large corporations, universities, and large-scale use.",
      price_enterprise: "Custom",
      feature_emissions_custom: "Custom Issuance Volume",
      feature_support_sla: "Priority Support and SLAs",
    ...
    faq: {
      ...
      q1_text: "It's a fundamental difference in where the trust lies:\n\nA digital signature on a PDF stores the proof of validity within the file itself. If the company that issued the signature certificate disappears, verification can become complicated.\n\nA Bravium certificate creates a cryptographic proof outside the file and anchors it permanently on a public blockchain. The proof does not depend on us or anyone else; it is a public, immutable record verifiable by anyone, forever. It's like having a notary seal in a global registry book, rather than just a signature on paper.",
      q2_title: "Do my users need to download an app or have a digital wallet?",
      q2_text: "No, and that's the main advantage of our system. There is no friction for the end-user.\n\nYour users receive a unique link or a QR code. By opening it in any browser (mobile or desktop), they access a public verification page where they can see the authenticity of the certificate instantly. It works on any device without needing to install anything.",
      q3_title: "What exactly is the 'blockchain' and why do you use it?",
      q3_text: "Think of the blockchain as a digital ledger or notary record that is public and cannot be erased or altered.\n\nWe use it because it offers immutability. When we seal the proof of a document, it is permanently recorded on thousands of computers around the world. This ensures that the proof of authenticity of your document cannot be manipulated or deleted by anyone, not even us.",
  ...
  helpPage: {
    title: "How Bravium Works",
    subtitle: "Understand the full lifecycle of a verifiable credential, from issuance to verification.",
    protagonists_title: "The Key Players",
    protagonist_institution_name: "The Issuing Institution",
    protagonist_institution_role: "Creates and issues the credentials (e.g., a university).",
    protagonist_recipient_name: "The Recipient",
    protagonist_recipient_role: "Receives and owns the credential (e.g., a student).",
    protagonist_verifier_name: "The Verifier",
    protagonist_verifier_role: "Needs to confirm the credential's validity (e.g., an HR department).",
    step1_title: "Step 1: Issuance",
    step1_subtitle: "The institution creates a verifiable credential.",
    step1_desc: "From the Bravium dashboard, the issuing institution (like a university) uses a template to create a credential for a recipient (like a student).",
    step1_point1: "Select a template (e.g., 'University Diploma').",
    step1_point2: "Fill in the student's details (name, major, date).",
    step1_point3: "On clicking 'Issue', Bravium generates a cryptographically secure certificate (JWS).",
    step2_title: "Step 2: Delivery",
    step2_subtitle: "The student receives their digital credential.",
    step2_desc: "The credential, in text format (JWS) along with a QR code and a PDF, is sent to the student. It's now theirs to keep forever.",
    step2_point1: "The student can store the JWS, save the PDF, or simply use the QR.",
    step2_point2: "They have full control to share it with anyone they choose.",
    step3_title: "Step 3: Verification",
    step3_subtitle: "An employer verifies the authenticity of the diploma.",
    step3_desc: "The student presents their credential to a potential employer. The employer can verify its validity in seconds, without contacting the university.",
    step3_point1: "Scan the QR code from the PDF or the student's mobile.",
    step3_point2: "Paste the JWS text into the 'Verify' page on Bravium's website.",
    step3_point3: "The system checks the cryptographic signature against the blockchain and instantly shows if the credential is valid and untampered.",
  },
  registerPage: {
  ...
  customersPage: {
    ...
    col_apiKey: "API Key",
    col_createdAt: "Creation Date",
    col_renewalDate: "Renewal Date",
    col_plan: "Plan",
    col_status: "Status",
    col_onboarding_status: "Onboarding",
    actions: "Actions",
    ...
    new_user_dialog_title: "New Customer Credentials",
    new_user_dialog_desc: "The customer has been created. Please share these credentials securely.",
    new_user_alert_title: "Important Password",
    new_user_alert_desc: "The password is the user's UID. This is the only time it will be shown. Copy and save it somewhere safe before closing this window.",
  },
  templatesPage: {
    ...
    form_public_label: "Public Template",
    form_public_desc: "Allow this template to be used in the public demo page.",
...
col_recipient: "Recipient",
  ...
  issueCredentialPage: {
    ...
    tab_single: "Single Issuance",
    tab_batch: "Batch Issuance (CSV)",
    ...
    close_button: "Close",
    batch_title: "Batch Issuance via CSV",
    batch_desc: "Follow the steps below to issue multiple credentials at once.",
    batch_file_error_title: "Template Not Supported",
    batch_file_error_desc: "Batch issuance is not supported for templates containing file attachment fields.",
    batch_step1_title: "Step 1: Download Template",
    batch_step1_desc: "Download the CSV template, open it in a spreadsheet editor, and fill in the data for each recipient.",
    batch_download_button: "Download CSV Template",
    batch_step2_title: "Step 2: Upload File",
    batch_step2_desc: "Upload the completed CSV file. Ensure the headers have not been modified.",
    batch_issue_button: "Issue Batch of Credentials",
    batch_progress_title: "Issuing Credentials...",
    batch_result_title: "Batch Issuance Complete",
    batch_result_desc: "{success} out of {total} credentials issued successfully.",
    batch_result_row: "Row"
  },
  cookieConsent: {
  ...
  cookiesPolicyPage: {
   ...
   profilePage: {
    ...
    profile_details_desc: "Update your name here. The email cannot be changed.",
    name_label: "Name",
    email_label: "Email",
    save_button: "Save Changes",
    name_update_success: "Name updated successfully.",
    name_update_fail: "Failed to update name.",
    name_required: "Name is required.",
    account_info_title: "Account Information",
    plan_label: "Current Plan",
    status_label: "Subscription Status",
    created_at_label: "Creation Date",
    renews_at_label: "Renewal Date",
    api_key_label: "API Key",
    security_title: "Security",
    security_desc: "Manage your account security settings.",
    change_password_button: "Change Password",
    password_reset_success: "Password reset email sent.",
    password_reset_fail: "Failed to send password reset email.",
    danger_zone_title: "Danger Zone",
    delete_account_button: "Delete Account",
    delete_account_dialog_title: "Are you absolutely sure?",
    delete_account_dialog_desc: "This action cannot be undone. This will permanently delete your account and remove your data from our servers.",
