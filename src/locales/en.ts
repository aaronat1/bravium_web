...
export const en = {
  ...
  helpPage: {
    ...
    step1_desc: "",
    step1_point1: "1. Design the Template: From their BRAVIUM dashboard, they use the visual editor to create the certificate template, defining fields like Student Name, Course Name, and Completion Date.",
    step1_point2: "2. Enter the Data: They fill in Elena's data in the issuance form.",
    step1_point3: "3. BRAVIUM generates the unique certificate (JWS and QR code) and seals its cryptographic proof immutably on the blockchain.",
    step2_title: "Step 2: Reception and Sharing (The Student's Perspective)",
    step2_subtitle: "ELENA instantly receives an email with her official certificate.",
    step2_desc: "",
    step2_point1: "Immediate Access: Inside the email, she finds the JWS string and the corresponding QR code. She doesn't need to create accounts or download apps.",
    step2_point2: "Shares for a Job Application: When applying for a job, Elena sends the QR code (or the JWS text) to David, the recruiter.",
    step3_title: "Step 3: Verification (The Recruiter's Perspective)",
    step3_subtitle: "DAVID, the recruiter, needs to verify her degree.",
    step3_desc: "Instant Verification: David goes to the 'Verify' section on bravium.es. He scans Elena's QR code with the tool.",
    step3_point1: "The platform confirms that the certificate was issued by ACADEMIA FUTURO.",
    step3_point2: "It verifies that Elena's data has not been altered.",
    step3_point3: "It shows the proof of its seal on the blockchain for full transparency.",
  },
  loginPage: {
